...
cpu_graph = blingbling.line_graph({ height = 18, width = 160, show_text = true, label = "Cpu: $percent %"})
mem_graph = blingbling.line_graph({ height = 18, width = 160, show_text = true, label = "Mem: $percent %"})
